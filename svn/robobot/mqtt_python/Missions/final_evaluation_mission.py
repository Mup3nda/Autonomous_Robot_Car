    ...
    objectives = [
     ...
     # region Following line approach roundabout
         ...
         DriveCircleObjective(
             ...
             revolutions=1.6105, # one full circle + half circle
             forward_cmd=0.28,
...
#        region Follow line until extra time
        ...
        #  DriveToLineUntilCurveObjective(curve_detection_delay_s=1.0, follow_speed=0.3),
         DelayObjective(1.0),
         SearchAndNavigateToHole(desired_distance=0.35,turn_rate=-0.5),
         ArmDownObjective(wait_after_s=2.0),
         DelayObjective(1.0), 
         GripperOpenObjective(),
         DelayObjective(1.0), 
      ...
      #region Get extra time return to line
        ...
        DriveToWaypointObjective(
         ...
         GripperOpenObjective(),
         ArmMiddleObjective(),
         LookForArucoObjective(marker_ids=[53,20], search_timeout_s=8.0,turn_rate=0),
    ...
    #      ),
     ...
     # region go to ball pick up location
         ...
         MissionBallFlowObjective(waypoint_nav_mode=WAYPOINT_NAV_MODE),
    # endregion
    #region get cubes    
        ###### LOOKING FOR CUBE
