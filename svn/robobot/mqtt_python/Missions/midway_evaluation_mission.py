...
#             ),
#        #endregion
#         DriveToLineObjective(follow_speed=0.5, stop_after_centering=False, max_line_distance_m=6.0),
#         DriveToLineUntilCurveObjective(curve_detection_delay_s=2.0, follow_speed=0.3),
#         DriveTurnAngleObjective(80.0, linear_cmd=0.01, turn_cmd=0.8, timeout_s=5.0),
#         SearchAndNavigateToGolfBall(desired_distance=0.37),
#         GripperOpenObjective(),
#         DelayObjective(1.0),
...
#         ArmUpObjective(),
#         DelayObjective(1.0), 
#         DriveTurnAngleObjective(-140.0, linear_cmd=0.01, turn_cmd=0.8, timeout_s=5.0),
#         DriveToWaypointObjective(
#               waypoint=(0.3,0),
#               is_local=True,
#               print_interval=20,
...
#               nav_mode=WAYPOINT_NAV_MODE,
#               ), 
#         #DriveTurnAngleObjective(30.0, linear_cmd=0.0, turn_cmd=0.8, timeout_s=5.0),
...
#         DriveTurnAngleObjective(100.0, linear_cmd=0.01, turn_cmd=0.8, timeout_s=5.0),
    ...
    #     ), 
     ...
     # region go to ball pick up location
         ...
         SearchAndNavigateToBlueBall(turn_rate=0.3, desired_distance=0.36),
     ...
     # region go to ball pick up location
        ...
        SearchAndNavigateToRedBall(desired_distance=0.35),
        GrabTargetObjective(nav_mode=WAYPOINT_NAV_MODE),
        DelayObjective(2.0),
     # end region
