...
# Lowered saturation to catch lighter/reflective areas

red_lower1 = (0, 170, 40)      # Lower red: H(0-10), S(min 200), V(min 120)
red_upper1 = (10, 255, 255)     # H(0-10), S(max), V(max)
red_lower2 = (170, 170, 40)    # Upper red: H(170-180), S(min 200), V(min 120)
red_upper2 = (180, 255, 255)    # H(170-180), S(max), V(max)
